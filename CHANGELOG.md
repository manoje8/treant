...
### Added
- **Parser plugin system** | Allow third-party parsers to register themselves via a `treant.parsers` entry point, removing the hard-coded `if/elif` in `get_parser_method`
